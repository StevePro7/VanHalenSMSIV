...
S:Ltest_screen.screen_test_screen_load$ro$1$30({2}DG,STtag_struct_record_object:S),R,0,0,[]
F:G$screen_test_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltest_screen.screen_test_screen_update$screen_type$1$31({2}DG,SC:U),B,1,4
S:Ltest_screen.screen_test_screen_update$ro$1$32({2}DG,STtag_struct_record_object:S),R,0,0,[]
S:Ltest_screen.screen_test_screen_update$input1$1$32({1}SC:U),R,0,0,[l]
