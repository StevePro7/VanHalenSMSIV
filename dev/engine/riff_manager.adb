...
F:G$engine_riff_manager_play$0$0({2}DF,SV:S),Z,0,1,0,0,0
S:Lriff_manager.engine_riff_manager_play$index$1$21({1}SC:U),B,1,4
...
S:Lriff_manager.engine_riff_manager_play$loop$1$22({1}SC:U),B,1,-1
